 ...
 */
final class InvalidSessionReconnectTest extends DiscordTestCase
{
    ...
    public function testReconnect()
    {
        ...
        $this->connection->shouldNotHaveReceived('close', [1001, 'reconnecting']);
        ...
        // Client should not resume after op => 9 && d !== true
